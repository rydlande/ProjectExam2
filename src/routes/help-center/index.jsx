export function HelpCenter() {
  return (
    <div className="min-h-screen bg-teal-light py-8">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white shadow sm:rounded-lg">
          <div className="px-4 py-5 sm:p-6">
            <h2 className="text-3xl font-bold leading-7 text-grey-700 sm:text-4xl sm:truncate">
              Help Center
            </h2>
            ...
            <div className="mt-6 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
              <div className="bg-grey-100 p-4 rounded-lg shadow">
                <h3 className="text-xl font-semibold text-grey-700">FAQs</h3>
                <p className="mt-2 text-grey-600">
                  Find answers to frequently asked questions.
                </p>
                <a href="#faqs" className="mt-4 text-teal hover:underline">
                  Learn More &rarr;
                </a>
              </div>
              <div className="bg-grey-100 p-4 rounded-lg shadow">
                <h3 className="text-xl font-semibold text-grey-700">Tutorials</h3>
                <p className="mt-2 text-grey-600">
                  Step-by-step guides to help you get started.
                </p>
                <a href="#tutorials" className="mt-4 text-teal hover:underline">
                  Learn More &rarr;
                </a>
              </div>
              <div className="bg-grey-100 p-4 rounded-lg shadow">
                <h3 className="text-xl font-semibold text-grey-700">Contact Us</h3>
                <p className="mt-2 text-grey-600">
                  Get in touch with our support team for further assistance.
                </p>
                <a href="#contact" className="mt-4 text-teal hover:underline">
                  Learn More &rarr;
                </a>
              </div>
            </div>
            ...
            <div id="faqs" className="mt-8">
              <h3 className="text-2xl font-semibold text-grey-700">Frequently Asked Questions</h3>
              <div className="mt-4">
            ...
            <div id="tutorials" className="mt-8">
              <h3 className="text-2xl font-semibold text-grey-700">Tutorials</h3>
              <div className="mt-4">
                <details className="mb-4">
                  <summary className="font-semibold cursor-pointer">
            ...
            <div id="contact" className="mt-8">
              <h3 className="text-2xl font-semibold text-grey-700">Contact Us</h3>
              <p className="mt-2 text-grey-600">
              ...
              <form className="mt-4">
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                  <div>
                    ...
                    <input
                      ...
                      name="name"
                      id="name"
                      className="mt-1 block w-full px-3 py-2 border border-grey-300 rounded-md shadow-sm placeholder-grey-400 focus:outline-none focus:ring-teal focus:border-teal sm:text-sm"
                    />
                  </div>
                  <div>
                ...
                <div className="mt-6">
                  <button
                    type="submit"
                    className="w-full inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-teal hover:bg-teal focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal"
                  >
                    Send Message
                  </button>
                </div>
