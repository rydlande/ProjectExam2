            ...
            <div className="bg-white p-8 rounded-lg shadow-lg w-3/4 max-w-4xl mt-6 max-h-[1100px] md:max-h-[800px]">
              ...
              <div className="grid-rows-3 md:grid md:grid-cols-3 gap-4 text-center md:mt-10">
                ...
                <Link to="/profile/bookings" className="bg-gray-100 p-4 rounded-lg shadow-md flex flex-col items-center my-3 md:my-0">
                  <div className="bg-gray-300 w-12 h-12 mb-2 rounded-md">
                  ...
                  <p className="text-gray-600 text-sm">Overview of all your upcoming bookings</p>
                </Link>

                {/* Venues */}
                <Link to="/profile/venues" className="bg-gray-100 p-4 rounded-lg shadow-md flex flex-col items-center my-3 md:my-0">
                  <div className="bg-gray-300 w-12 h-12 mb-2 rounded-md flex justify-center">
                  ...
                  <p className="text-gray-600 text-sm">Overview of all your venues</p>
                </Link>

                {/* Edit profile */}
                <Link to="/profile/settings" className="bg-gray-100 p-4 rounded-lg shadow-md flex flex-col items-center my-3 md:my-0">
                  <div className="bg-gray-300 w-12 h-12 mb-2 rounded-md">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={0.7} stroke="currentColor" className="w-12 h-12">
                  ...
                  <p className="text-gray-600 text-sm">Update your profile information here</p>
                </Link>
              </div>
            </div>
          </div>        
